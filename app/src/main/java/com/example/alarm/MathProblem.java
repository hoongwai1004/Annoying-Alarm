...
public class MathProblem {
    ...
    public MathProblem(int numParts) {
        ...
        while(combinedParts.contains(Operator.ADD) ||combinedParts.contains(Operator.SUBTRACT) || combinedParts.contains(Operator.MULTIPLY)){
            int i = 0;
			...
			answer = (Float)combinedParts.get(i-1) + (Float)combinedParts.get(i+1);
			}else if (combinedParts.get(i) == Operator.SUBTRACT){
				answer = (Float)combinedParts.get(i-1) - (Float)combinedParts.get(i+1);
			}else {
                answer = (Float)combinedParts.get(i-1) * (Float)combinedParts.get(i+1);
            }
